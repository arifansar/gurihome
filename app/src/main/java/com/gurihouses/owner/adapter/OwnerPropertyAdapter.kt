package com.gurihouses.owner.adapter
...
class OwnerPropertyAdapter(val ctx: Context?, val list: List<OwnerProperty>, val listener:(OwnerProperty)->Unit): RecyclerView.Adapter<OwnerPropertyAdapter.ViewHolder>()  {
